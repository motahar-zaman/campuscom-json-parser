'''
This script is for normalizing various types of time_to_complete field of affiliate product into seconds
it works for mysql database

set correct credentials of mysql database into Database config variable
set the products table name into table_name variable
then run "python normalize_time.py"

Working Procedure:
1. fetch all the products from mysql database
2. convert the time into seconds depending on data format
3. update product
'''
import sys
